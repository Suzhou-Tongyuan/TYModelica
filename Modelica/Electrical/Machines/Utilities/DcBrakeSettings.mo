...
record DcBrakeSettings "Setting for DC current braking"
  ...
  parameter SI.Current Idc=
    ...
    else if layout=="Y2" then INominal*sqrt(3/2) 
    else if layout=="D2" then INominal*3/sqrt(2) 
  ...
  parameter SI.Current is[3]=
    ...
    else if layout=="Y2" then Idc*{1,-1,0} 
    else if layout=="D2" then Idc*{2/3,-1/3,-1/3} 
    else                     Idc*{1/2,-1/2,0}
